...
/* harmony import */ var react_countdown_now__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! react-countdown-now */ "./node_modules/react-countdown-now/dist/index.es.js");
/* harmony import */ var socket_io_client__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! socket.io-client */ "./node_modules/socket.io-client/lib/index.js");
...
var socket = socket_io_client__WEBPACK_IMPORTED_MODULE_21___default()(apiConfig.serverUrl);

var AuctionDetail =
/*#__PURE__*/
function (_React$Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_9__["default"])(AuctionDetail, _React$Component);

  function AuctionDetail(props) {
    var _this;

    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_4__["default"])(this, AuctionDetail);

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_6__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_7__["default"])(AuctionDetail).call(this, props));
    ...
    _this.handleNewBid = _this.handleNewBid.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8__["default"])(_this));
    _this.handleInputChange = _this.handleInputChange.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8__["default"])(_this));
    _this.getSale = _this.getSale.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8__["default"])(_this));
    _this.handleKeyDown = _this.handleKeyDown.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8__["default"])(_this));
    return _this;
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(AuctionDetail, [{
    ...
    value: function handleInputChange(event) {
      ...
      this.setState(Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__["default"])({}, name, value));
    }
  }, {
    key: "handleKeyDown",
    ...
    value: function handleNewBid() {
      ...
      socket.emit('new bid', {
        ...
        bid: {
          amount: _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(this.state.bid),
    ...
    value: function getUser(token) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_17___default.a.post(url, {}, {
        headers: {
          authorization: token
        }
    ...
    value: function getSale(id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_17___default.a.get(url).then(function (response) {
    ...
    value: function render() {
      ...
      var slides = items.map(function (item) {
        return __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["CarouselItem"], {
      ...
      return __jsx(_components_AppLayout__WEBPACK_IMPORTED_MODULE_11__["default"], {
        ...
        __self: this
      }, " ", this.state.sale.title, " ", userEmail === this.state.sale.owner.email ? __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["Badge"], {
        className: "ml-2",
        color: "dark",
        pill: true,
        __source: {
        ...
        __self: this
      }, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["Carousel"], {
        ...
        __self: this
      }, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["CarouselIndicators"], {
        items: items,
        activeIndex: this.state.activeIndex,
        ...
        __self: this
      }), slides, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["CarouselControl"], {
        direction: "prev",
        ...
        __self: this
      }), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["CarouselControl"], {
        direction: "next",
        directionText: "Next",
        onClickHandler: next,
        __source: {
        ...
        __self: this
      }, "Teklif vermek i\xE7in", __jsx(next_link__WEBPACK_IMPORTED_MODULE_16___default.a, {
        href: '/registration',
        __source: {
          fileName: _jsxFileName,
          lineNumber: 257
        ...
        __self: this
      }, " kay\u0131t olun")), " veya", __jsx(next_link__WEBPACK_IMPORTED_MODULE_16___default.a, {
        href: '/login',
        __source: {
          fileName: _jsxFileName,
          lineNumber: 260
        ...
        __self: this
      }, "Teklif Ver"), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["Form"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 283
        },
        ...
        __self: this
      })), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["Fade"], {
        ...
        __self: this
      }, this.state.biddingFade.message)), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["Button"], {
        ...
        className: "text-center float-bottom mt-3 text-success",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 310
        },
        __self: this
      }, __jsx(react_countdown_now__WEBPACK_IMPORTED_MODULE_20__["default"], {
        ...
        icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_15__["faMoneyBill"],
        width: "16",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 320
        ...
        icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_15__["faUsers"],
        width: "16",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 326
        ...
        icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_15__["faThumbsUp"],
        width: "16",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 330
        ...
        icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_15__["faCalendarAlt"],
        width: "16",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 336
    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = context.query.id;
            token = Object(_utils_auth__WEBPACK_IMPORTED_MODULE_18__["getToken"])(context);
...
//# sourceMappingURL=[id].js.18628579bef32ae3a037.hot-update.js.map