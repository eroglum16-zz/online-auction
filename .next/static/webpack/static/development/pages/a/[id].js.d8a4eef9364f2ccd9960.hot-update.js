    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            id = context.query.id;
            url = apiConfig.serverUrl + '/sale/' + id;
            sale = axios__WEBPACK_IMPORTED_MODULE_14___default.a.get(url).then(function (response) {
...
//# sourceMappingURL=[id].js.d8a4eef9364f2ccd9960.hot-update.js.map