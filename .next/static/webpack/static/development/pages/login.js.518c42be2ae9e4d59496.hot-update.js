...
function (_React$Component) {
  ...
  function Login(props) {
    ...
    var registered = router.query.registered ? true : false;
    _this.state = {
      alert: {
        message: '',
        color: ''
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Login, [{
    ...
    value: function render() {
      return __jsx(_components_AppLayout__WEBPACK_IMPORTED_MODULE_5__["default"], {
        ...
        __self: this
      }, this.state.alert.message.length > 0 ? __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_7__["Alert"], {
...
//# sourceMappingURL=login.js.518c42be2ae9e4d59496.hot-update.js.map