  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Sale, [{
    ...
    value: function componentDidMount() {
      ...
      Object(_utils_api__WEBPACK_IMPORTED_MODULE_16__["getSale"])(this.props.id).then(function (response) {
        ...
        if (response.sale.owner.email !== _this2.state.user.email) {//Router.push('/sales');
        }
    ...
    value: function render() {
      ...
      return __jsx(_components_AppLayout__WEBPACK_IMPORTED_MODULE_8__["default"], {
        ...
        __self: this
      }, this.state.sale.title, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Badge"], {
        className: "ml-3",
        color: "success",
        pill: true,
        __source: {
...
//# sourceMappingURL=[id].js.9e3bb25e68fc7a950746.hot-update.js.map