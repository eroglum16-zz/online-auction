  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Registration, [{
    ...
    value: function handleRegistration() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_12___default.a.post(url, {
        ...
        if (!error) return;else if (!error.response) {
          console.log(error);
          this.setState({
            alertMessage: "Sunucudaki bir sorundan dolayı kayıt işleminizi şu anda gerçekleştiremiyoruz."
          });
        } else {
          this.setState({
...
//# sourceMappingURL=registration.js.219d2f01e1afefb265b3.hot-update.js.map