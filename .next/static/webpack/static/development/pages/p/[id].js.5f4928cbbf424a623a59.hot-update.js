...
/* harmony import */ var _utils_miscellaneous__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../utils/miscellaneous */ "./utils/miscellaneous.js");
/* harmony import */ var _components_ChatBox__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../components/ChatBox */ "./components/ChatBox.js");
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Purchase, [{
    ...
    value: function componentDidMount() {
      ...
      Object(_utils_auth__WEBPACK_IMPORTED_MODULE_13__["getUser"])(this.props.token).then(function (user) {
        _this2.setState({
          user: user
        });
      });
      Object(_utils_api__WEBPACK_IMPORTED_MODULE_14__["getSale"])(this.props.id).then(function (response) {
        if (!response) {
          next_router__WEBPACK_IMPORTED_MODULE_15___default.a.push('/purchases');
          return;
        }
    ...
    value: function render() {
      var seller = this.state.sale.owner.nameSurname;
      ...
      return __jsx(_components_AppLayout__WEBPACK_IMPORTED_MODULE_8__["default"], {
        ...
        __self: this
      }, this.state.sale.title, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_10__["Badge"], {
        className: "ml-3",
        color: "success",
        pill: true,
        __source: {
        ...
        __self: this
      }, "Kapan\u0131\u015F Tarihi: "), Object(_utils_miscellaneous__WEBPACK_IMPORTED_MODULE_16__["toTimeString"])(this.state.sale.endDate)))), __jsx("div", {
        className: "col-md-1",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 87
        ...
        __self: this
      }, __jsx(_components_ChatBox__WEBPACK_IMPORTED_MODULE_17__["default"], {
        interlocutor: seller,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            token = Object(_utils_auth__WEBPACK_IMPORTED_MODULE_13__["auth"])(ctx);
...
//# sourceMappingURL=[id].js.5f4928cbbf424a623a59.hot-update.js.map